        ...
        <div className={styles.contentGrid}>
          ...
          >
            ...
            <div className={styles.visualElementContent}>
              <i className="bi bi-question-circle" aria-hidden="true" style={{ fontSize: '3rem', marginBottom: '1rem', color: 'var(--accent-yellow)' }}></i>
              ...
              >
                <i className="bi bi-chat-text" aria-hidden="true" style={{ marginRight: '0.5rem' }}></i>
                Chat with us
              </a>
            </div>
          </motion.div>
            ...
            >
              <div className={styles.faqQuestion}>
                ...
                <div className={styles.faqIcon}>
                  <i className={`bi ${openIndex === index ? 'bi-dash' : 'bi-plus'}`} aria-hidden="true"></i>
                </div>
              </div>
