...
| `/case-studies/forgingblock-dashboard` | `/og/case-studies.png` | `ForgingBlock Dashboard Case Study | Flat 18` | `Payments experience for merchants monitoring invoices, cash flow, and payouts.` | Shared case study OG image. |
